...
urlpatterns = [
    ...
    path('all_sessions/', api.all_sessions, name='all_sessions'),
    path('all_sessions/<int:session_id>/delete/', api.delete_session, name='delete_session'),
    ...
    path('training/session/<int:session_id>/delete/', training.delete_session, name='delete_train_session'),
    ...
    path('add_visit/', visit.submit_man_visiting_request, name='add_visit'),
