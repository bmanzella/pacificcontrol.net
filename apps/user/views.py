...
def sort_controllers(query_set):
    ...
    return {
        'ZAN Oceanic': controllers_ordered[8],
        'Full (HCF & ZAN) Center': controllers_ordered[7],
        'ZAN Center': controllers_ordered[10],
        'HCF Center': controllers_ordered[9],
        'Full (HCF & ZAN) Major Approach': controllers_ordered[6],
        'ZAN Major Approach': controllers_ordered[12],
        'HCF Major Approach': controllers_ordered[11],
        'Minor Approach': controllers_ordered[5],
        'Full (HCF & ZAN) Major Tower': controllers_ordered[4],
        'ZAN Major Tower': controllers_ordered[13],
        'HCF Major Tower': controllers_ordered[14],
        'Minor Tower': controllers_ordered[3],
        'ZAN Major Ground': controllers_ordered[15],
        'HCF Major Ground': controllers_ordered[16],
        'Full (HCF & ZAN) Major Ground': controllers_ordered[2],
