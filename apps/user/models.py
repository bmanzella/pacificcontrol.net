...
class User(models.Model):
    ...
    ENDORSEMENTS = (
        ...
        (2, 'Major Endorsement'),
        (3, 'Solo Endorsement'),
	(4, 'HCF Major Endorsement'),
	(5, 'ZAN Major Endorsement')
    )
    # User Details
    ...
    def cert_int(self):
        if self.ocn_cert == 2:
            ...
            return 7
        elif self.ctr_cert == 4:
            return 9
        elif self.ctr_cert == 5:
            return 10
        elif self.app_cert == 2:
            return 6
        elif self.app_cert == 4:
            return 11
        elif self.app_cert == 5:
            return 12
        elif self.app_cert == 1 or self.app_cert == 3:
            return 5
        elif self.twr_cert == 2:
            return 4
        elif self.twr_cert == 4:
            return 14
        elif self.twr_cert == 5:
            return 13
        elif self.twr_cert == 1 or self.twr_cert == 3:
            return 3
        elif self.gnd_cert == 2:
            return 2
        elif self.gnd_cert == 4:
            return 16
        elif self.gnd_cert == 5:
            return 1
